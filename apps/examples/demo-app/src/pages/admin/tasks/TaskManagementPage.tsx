					...
					<div className="flex justify-between items-center">
						<div>
							...
							<p className="text-gray-600 mt-1">
								Assign, monitor, and complete workflow tasks
							</p>
						</div>
					</div>
				</div>
							...
							<div className="grid grid-cols-2 gap-6">
								<div>
									...
									<div className="space-y-2 text-sm">
										...
										<p>
											<span className="font-medium">Business Key:</span>{" "}
										...
										<p>
											...
											<span
												className={`px-2 py-1 rounded text-xs ${getStatusColor(selectedTask.status)}`}
											>
												{selectedTask.status}
											</span>
										</p>
