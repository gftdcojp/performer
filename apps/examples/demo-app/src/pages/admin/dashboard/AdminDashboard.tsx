...
export default function AdminDashboard() {
	...
	const processMetadata =
		allProcessMetadata[selectedProcessType as keyof typeof allProcessMetadata];
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					...
					<div className="bg-white rounded-lg shadow p-6">
						...
						<div className="space-y-4">
							{Object.entries(processMetadata.categories).map(
								([key, category]) => {
									const catStats = stats.categoryStats[key] || {
										total: 0,
										completed: 0,
										avgTime: 0,
									};
