			...
			<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
						...
						<br />
						Experience complete order processing workflow with business process
						management
					</p>
				...
				<div className="grid md:grid-cols-3 gap-8 mb-16">
					<div className="bg-white rounded-lg shadow-lg p-6">
						...
						<p className="text-gray-600">
							Visual business process modeling with executable workflows. Define
							complex business logic using industry-standard BPMN notation.
						</p>
					</div>
					...
					<div className="bg-white rounded-lg shadow-lg p-6">
						...
						<p className="text-gray-600">
							Graph database for complex relationships and queries. Type-safe
							Cypher queries with automatic schema management.
						</p>
					</div>
				</div>
				...
				<div className="bg-white rounded-lg shadow-lg p-8 mb-16">
					...
					<div className="text-center mt-8">
						<p className="text-gray-600 mb-4">
							This demo showcases a complete BPMN workflow with conditional
							logic, human tasks, and automated service tasks.
						</p>
						<button
							onClick={() => handleStartDemo("order")}
