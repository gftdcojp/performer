...
export const integratedProcessMetadata = {
  ...
  version: "1.0.0",
  description: "Event-driven orchestration of multiple business processes with human oversight",
  processes: {
    order: {
  ...
  tasks: {
    EventClassification: {
      type: "service",
      description: "Classify incoming business events and route to appropriate processes",
      timeout: 10000,
      category: "routing"
    },
    StartOrderProcess: {
    ...
    FollowUpTask: {
      type: "user",
      description: "Perform follow-up tasks identified during process completion",
  ...
  eventTypes: {
    order_created: { process: "order", priority: "normal", description: "New order placed" },
    order_updated: { process: "order", priority: "normal", description: "Order modification" },
    return_requested: { process: "returns", priority: "normal", description: "Return request submitted" },
    return_submitted: { process: "returns", priority: "normal", description: "Return items received" },
    support_ticket: { process: "support", priority: "normal", description: "Support ticket created" },
    customer_inquiry: { process: "support", priority: "low", description: "General customer inquiry" },
    low_stock_alert: { process: "inventory", priority: "high", description: "Inventory below reorder point" },
    inventory_check: { process: "inventory", priority: "low", description: "Scheduled inventory review" }
  },
  metrics: {
    totalProcesses: 4,
...
export const humanInTheLoopMetadata = {
  ...
  version: "1.0.0",
  description: "Automated processes with human oversight and iterative improvement",
  loopPatterns: {
    reviewApproval: {
      name: "Review & Approval Loop",
      description: "Automated processing followed by human review with revision capability",
      maxIterations: 3,
