...
export const processMetadata = {
  ...
  version: "2.0.0",
  description: "Advanced order processing with inventory, credit, multi-level approval, and logistics",
  tasks: {
    ValidateOrder: {
      type: "service",
      description: "Validate order data, customer info, and basic business rules",
      timeout: 30000,
      category: "validation"
    },
    InventoryCheck: {
    ...
    RiskAssessment: {
      type: "service",
      description: "Calculate risk score based on order value, customer history, and market conditions",
      timeout: 15000,
      category: "validation"
    },
    ComplianceReview: {
