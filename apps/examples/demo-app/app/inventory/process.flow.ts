...
export const inventoryProcessMetadata = {
  ...
  version: "1.0.0",
  description: "Automated inventory monitoring, replenishment, and optimization",
  tasks: {
    StockLevelAnalysis: {
      type: "service",
      description: "Analyze current stock levels against thresholds and demand patterns",
      timeout: 30000,
      category: "analysis"
    },
    SupplierEvaluation: {
    ...
    PurchaseOrderApproval: {
      type: "user",
      description: "Review and approve purchase orders for inventory replenishment",
    ...
    InventoryOptimization: {
      type: "service",
      description: "Analyze inventory patterns and suggest optimization strategies",
      timeout: 60000,
