...
export const supportProcessMetadata = {
  ...
  version: "1.0.0",
  description: "Multi-tier customer support with triage, escalation, and resolution tracking",
  tasks: {
    CategorizeRequest: {
      type: "service",
      description: "Automatically categorize support request based on content analysis",
      timeout: 15000,
      category: "triage"
    },
    ImmediateResponse: {
